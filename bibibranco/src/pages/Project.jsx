...
let projetos = [
    {
        id:1,
        nome: 'product design', 
        description:'I’ve been working with end-to-end user experience design for the last five years, creating meaningful blablabla for global companies such as Itau Unibanco, Melhor Envio, AEDIT',
        content:[
            {
                imgUrl: '../img01.jpg',
                imgDesc: 'abuble',
